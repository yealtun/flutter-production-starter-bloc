...
mixin _$AuthState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(Token token) authenticated,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(Token token)? authenticated,
...
abstract class _Authenticated implements AuthState {
  const factory _Authenticated(final Token token) = _$AuthenticatedImpl;
...
abstract class _Error implements AuthState {
  const factory _Error(final ApiException error) = _$ErrorImpl;
